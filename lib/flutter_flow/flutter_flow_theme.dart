...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF272727);
  late Color secondary = const Color(0xFFEFDF10);
  late Color tertiary = const Color(0xFF98900D);
  late Color alternate = const Color(0xFFA2A5AF);
  ...
  late Color accent3 = const Color(0xFF505050);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF198754);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFBB2124);
  late Color info = const Color(0xFF6C757D);
}
