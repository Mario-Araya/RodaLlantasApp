  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<OrdersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersRecord> adminOrdersOrdersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final adminOrdersOrdersRecord = adminOrdersOrdersRecordList.isNotEmpty
            ? adminOrdersOrdersRecordList.first
            : null;
