...
export 'new_category_model.dart';

class NewCategoryWidget extends StatefulWidget {
  const NewCategoryWidget({super.key});

  @override
  State<NewCategoryWidget> createState() => _NewCategoryWidgetState();
}

class _NewCategoryWidgetState extends State<NewCategoryWidget> {
  late NewCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewCategoryModel());
