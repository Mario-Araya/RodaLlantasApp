...
class _NewProductWidgetState extends State<NewProductWidget> {
  ...
  void initState() {
    ...
    _model.txtAmountTextController ??= TextEditingController();
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.txtAmountTextController,
                                            focusNode:
                                                _model.txtAmountFocusNode,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'Cantidad',
                                            ...
                                            validator: _model
                                                .txtAmountTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
                                  ...
                                  StreamBuilder<List<CategoriesRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<CategoriesRecord>
                                          btnAddProductCategoriesRecordList =
                                          snapshot.data!;
                                      // Return an empty Container when the item does not exist.
                                      if (snapshot.data!.isEmpty) {
                                        return Container();
                                      }
                                      final btnAddProductCategoriesRecord =
                                          btnAddProductCategoriesRecordList
                                                  .isNotEmpty
                                              ? btnAddProductCategoriesRecordList
                                                  .first
                                        ...
                                        onPressed: () async {
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title:
                                                    const Text('Creado Exitosamente'),
                                                content: const Text(
