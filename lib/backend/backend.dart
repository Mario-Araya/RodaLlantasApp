...
import 'schema/subproducts_record.dart';
import 'schema/carrito_temp_record.dart';
...
export 'schema/subproducts_record.dart';
export 'schema/carrito_temp_record.dart';
...
/// Functions to query SubproductsRecords (as a Stream and as a Future).
Future<int> querySubproductsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SubproductsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SubproductsRecord>> querySubproductsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SubproductsRecord.collection,
      SubproductsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SubproductsRecord>> querySubproductsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query CarritoTempRecords (as a Stream and as a Future).
Future<int> queryCarritoTempRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CarritoTempRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CarritoTempRecord>> queryCarritoTempRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CarritoTempRecord.collection,
      CarritoTempRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CarritoTempRecord>> queryCarritoTempRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
