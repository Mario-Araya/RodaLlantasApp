...
import 'history_quotes_model.dart';
export 'history_quotes_model.dart';

class HistoryQuotesWidget extends StatefulWidget {
  const HistoryQuotesWidget({super.key});

  @override
  State<HistoryQuotesWidget> createState() => _HistoryQuotesWidgetState();
}

class _HistoryQuotesWidgetState extends State<HistoryQuotesWidget> {
  late HistoryQuotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoryQuotesModel());
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Placa: ${listViewQuotesRecord.carPlate}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                                    .override(
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Descripción: ${listViewQuotesRecord.description}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                                    .override(
